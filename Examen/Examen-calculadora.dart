...
num hipotenusa(num cateto1, num cateto2){
  final num cateto1AlCuadrado = cateto1 * cateto1;
  final num cateto2AlCuadrado = cateto2 * cateto2;
  final num sumaCatetos = cateto1AlCuadrado + cateto2AlCuadrado;
...
main() {
  calculadora();
   ...
   calculadora(){
     ...
     print('CONVERTORES DE GRADOS: 5-transformar de sexagesimal a radian, 5-transformar de radian a sexagesimal');
     ...
     if(numeroOperacion == 11){
       ...
       calculadora();
        ...
        cateto1 = num.parse(stdin.readLineSync());
        stdout.write('digite el valor del segundo cateto');
        cateto2 = num.parse(stdin.readLineSync());
        ...
        y1 = num.parse(stdin.readLineSync());
        puntoInicial = [x1,y1];
        ...
        y2 = num.parse(stdin.readLineSync());
        puntoFinal = [x2,y2];
